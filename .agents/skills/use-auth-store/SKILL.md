...
Defined in [`src/hooks/useAuthStore.js`](../../hooks/useAuthStore.js):
...
[`RequireAuth`](../../components/layout/require-auth.jsx) is the layout-level guard wrapping all protected routes. It handles three states:
